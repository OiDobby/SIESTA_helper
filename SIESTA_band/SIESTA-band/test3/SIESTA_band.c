...
void gnuband(FILE *filename,char *material_name,double fermi_level,int bnd_num,int spin){
 ...
 int a;
  ...
  filename=fopen("./gnuband", "wt");
   ...
   fprintf(filename,"set xtic (\"{/Symbol G}\"0, \"K\"0.745356, \"M\"1.118034, \"{/Symbol G}\"1.618034)\n");
   ...
   fprintf(filename,"set xtic font \"Times Roman,30\"\n");
   fprintf(filename,"set ytic font \"Times Roman,30\"\n");
   fprintf(filename,"set tics font \"Times Roman,30\"\n");
   fprintf(filename,"set tmargin 3\n");
   fprintf(filename,"set bmargin 6\n");
   fprintf(filename,"set lmargin 10\n");
   fprintf(filename,"set rmargin 2\n");
   fprintf(filename,"set xlabel 'Wave Vector' font \"Times Roman, 36\" offset 0,-1.5,0\n");
   fprintf(filename,"set ylabel 'E-E_F (eV)' font \"Times Roman, 36\" offset -2,0,0\n");
